...
SUPPORT_MOD_MAD_MP3 ?= true
MAD_MP3_LIBRARY_PATH := external/libmad
LOCAL_CFLAGS += -DMP3_MAD_MUSIC
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/$(MAD_MP3_LIBRARY_PATH)/android
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/$(MAD_MP3_LIBRARY_PATH)/

#加入flac
LOCAL_CFLAGS += -DFLAC_MUSIC
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/external\flac\include
LOCAL_LDFLAGS += $(LOCAL_PATH)/../libs/libFLAC.a
...
LOCAL_SHARED_LIBRARIES := SDL2 libmad
